...
- Get [Support](https://app-generator.dev/ticket/create/?generated_repo=https://github.com/app-generator/django-soft-1773483917) via `eMail` and `Discord`
- Resources:
...
```bash
$ git clone https://github.com/django-soft-1773483917.git
$ cd django-soft-1773483917
```
